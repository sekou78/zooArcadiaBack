 ...
 */
final class Version20250215111046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE habitat (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, comment_habitat VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3B37B2E8ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service_restaurant (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, nom VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, heure_service VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7DC42B8BED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service_visite_petit_train (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, parcours VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, disponibilite LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', duree VARCHAR(50) NOT NULL, INDEX IDX_FC21294EED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE habitat ADD CONSTRAINT FK_3B37B2E8ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
        ...
        $this->addSql('ALTER TABLE service_restaurant ADD CONSTRAINT FK_7DC42B8BED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
        $this->addSql('ALTER TABLE service_visite_petit_train ADD CONSTRAINT FK_FC21294EED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitat DROP FOREIGN KEY FK_3B37B2E8ED5CA9E6');
        ...
        $this->addSql('ALTER TABLE service_restaurant DROP FOREIGN KEY FK_7DC42B8BED5CA9E6');
        $this->addSql('ALTER TABLE service_visite_petit_train DROP FOREIGN KEY FK_FC21294EED5CA9E6');
        ...
        $this->addSql('DROP TABLE service_restaurant');
        $this->addSql('DROP TABLE service_visite_petit_train');
